...
__global__ void
CostAggregationKernelDiagonalDownUpRightLeft( uint8_t* d_cost,
                                              uint8_t* d_L,
                                              const int P1,
                                              const int P2,
                                              const int rows,
...
template< class T >
__global__ void
CostAggregationKernelDiagonalDownUpLeftRight( uint8_t* d_cost,
                                              uint8_t* d_L,
                                              const int P1,
                                              const int P2,
                                              const int rows,
...
__global__ void
CostAggregationKernelDiagonalUpDownRightLeft( uint8_t* d_cost,
                                              uint8_t* d_L,
                                              const int P1,
                                              const int P2,
                                              const int rows,
...
__global__ void
CostAggregationKernelDiagonalUpDownLeftRight( uint8_t* d_cost,
                                              uint8_t* d_L,
                                              const int P1,
                                              const int P2,
                                              const int rows,
...
__global__ void
CostAggregationKernelLeftToRight( uint8_t* d_cost,
                                  uint8_t* d_L,
                                  const int P1,
                                  const int P2,
                                  const int rows,
...
__global__ void
CostAggregationKernelRightToLeft( uint8_t* d_cost,
                                  uint8_t* d_L,
                                  const int P1,
                                  const int P2,
                                  const int rows,
...
template< class T >
__global__ void
CostAggregationKernelDownToUp( uint8_t* d_cost,
                               uint8_t* d_L,
                               const int P1,
                               const int P2,
                               const int rows,
...
__global__ void
CostAggregationKernelUpToDown( uint8_t* d_cost,
                               uint8_t* d_L,
                               const int P1,
                               const int P2,
                               const int rows,
