...
__global__ void
MedianFilter3x3( const uint8_t* __restrict__ d_input,
...
MedianFilter( const T* __restrict__ d_input, T* __restrict__ d_out, const uint32_t rows, const uint32_t cols )
{
